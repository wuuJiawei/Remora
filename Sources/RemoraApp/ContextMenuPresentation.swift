...
enum ContextMenuIconCatalog {
    ...
    static let managePortForwards = "point.3.connected.trianglepath.dotted"
    static let extensionScripts = "scroll"
    static let runScript = "play.circle"
    static let refresh = "arrow.clockwise"
    static let newItems = "plus"
    ...
    static let transfer = "arrow.up.arrow.down"
    ...
    static let quickPath = "star"
    static let openWith = "square.and.pencil"
