...
- [ ] Select the exact reviewed libssh2 release/commit, not an unreviewed moving HEAD.
- [ ] Select and pin a crypto backend that can be statically distributed on macOS.
